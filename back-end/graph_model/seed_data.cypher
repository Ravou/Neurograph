...
WITH n,
  CASE WHEN n % 4 = 0 THEN 1 WHEN n % 4 = 1 THEN 2 WHEN n % 4 = 2 THEN 3 ELSE 4 END AS urgency_level,
  CASE WHEN n % 3 = 0 THEN 1 WHEN n % 3 = 1 THEN 2 ELSE 3 END AS impact_level
MATCH (svc:BusinessService {id:1})        // RSE-Platform
MATCH (res:CloudResource {id:'r1'})       // rse-app-prod
MATCH (u:Urgency {level: urgency_level})
MATCH (imp:Impact {level: impact_level})
